...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../../../../../.nvm/versions/node/v8.11.1/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../../../../../../.nvm/versions/node/v8.11.1/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../../node_modules/object-assign/index.js":[function(require,module,exports) {
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
(function () {
  ...
  var advertiseParams, app, getAdvertisingParams, initialize, isAdvertise, onErr, setAdvertisingParams, startAdvertise, stopAdvertise, $advertiseInfo; //"services":["45745c60-7b1a-11e8-9c9c-2d42b21b1a3"], //iOS
        ...
        bluetoothle.initializePeripheral(function (result) {
          var params = {
            ...
            characteristics: [{
              ...
              permissions: {
                read: true,
                write: true //readEncryptionRequired: true,
              ...
              properties: {
                ...
                write: true,
                notify: true,
                indicate: true //authenticatedSignedWrites: true,
  ...
  startAdvertise = function startAdvertise() {
    return new Promise(function (resolve, reject) {
      initialize().then(function () {
        stopAdvertise().then(function () {
          bluetoothle.startAdvertising(function (d) {
            resolve();
            alert('advertising started');
          }, function (d) {
            alert('advertising failed');
            onErr(d);
            reject();
  ...
  stopAdvertise = function stopAdvertise() {
    return new Promise(function (resolve, reject) {
      bluetoothle.stopAdvertising(function () {
        resolve();
  ...
  isAdvertise = function isAdvertise() {
    return new Promise(function (resolve, reject) {
  ...
  setAdvertisingParams = function setAdvertisingParams(val) {
    advertiseParams = JSON.parse($advertiseInfo.val());
  };

  getAdvertisingParams = function getAdvertisingParams() {
  ...
  var app = {
    ...
    onDeviceReady: function onDeviceReady() {
      ...
      $('#start-advertising').on('click', function () {
        startAdvertise();
      });
      $('#stop-advertising').on('click', function () {
        stopAdvertise();
      });
      $('#is-advertising').on('click', function () {
        isAdvertise().then(function (result) {
          alert("is advertising = ".concat(JSON.stringify(result)));
        });
      });
...
},{"jquery":"../../node_modules/jquery/dist/jquery.js","react":"../../node_modules/react/index.js"}],"../../../../../../.nvm/versions/node/v8.11.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
